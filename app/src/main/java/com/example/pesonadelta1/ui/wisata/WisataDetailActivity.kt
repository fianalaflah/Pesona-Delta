...
class WisataDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.wisata_activity_detail)
    ...
    private fun putData(intentThatStartedThisActivity : Intent) {
        ...
        var deskripsi = intentThatStartedThisActivity.getStringExtra(Intent.EXTRA_INSTALLER_PACKAGE_NAME)
        ...
        WisataPhotoDetail.setImageResource(photo)
        WisataNamaDetail.text = nama
       WisataDeskripsiDetail.text = deskripsi
    ...
    private fun openMap(latitude: String, longitude: String, WisataNama: String) {
        val showMapActivity = Intent(this, WisataMaps::class.java)
        showMapActivity.putExtra(Intent.ACTION_ASSIST, latitude)
        showMapActivity.putExtra(Intent.ACTION_PICK, longitude)
        showMapActivity.putExtra(Intent.ACTION_APPLICATION_PREFERENCES, WisataNama)

        startActivity(showMapActivity)
    }

    private fun openWeb(url: String) {
        val showWebActivity = Intent(this, WisataWebsite::class.java)
