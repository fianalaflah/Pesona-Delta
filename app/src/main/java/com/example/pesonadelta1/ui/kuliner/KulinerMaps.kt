...
class KulinerMaps : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.kuliner_activity_maps)
        //        custom start
        ...
        if(intentThatStartedThisActivity.hasExtra(Intent.ACTION_ASSIST)) {
            Toast.makeText(this@KulinerMaps, "lat : " + this.lat + ", long : " + this.long, Toast.LENGTH_LONG).show()
        } else {
