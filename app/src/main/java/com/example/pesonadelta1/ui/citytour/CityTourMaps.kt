...
class CityTourMaps : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.citytour_activity_maps)
        ...
        if(intentThatStartedThisActivity.hasExtra(Intent.ACTION_ASSIST)) {
            Toast.makeText(this@CityTourMaps, "lat : " + this.lat + ", long : " + this.long, Toast.LENGTH_LONG).show()
        } else {
