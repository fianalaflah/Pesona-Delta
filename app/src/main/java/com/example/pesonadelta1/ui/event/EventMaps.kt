...
class EventMaps : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.event_activity_maps)
        ...
        this.long = longitude
        val nameLocal =
            intentThatStartedThisActivity.getStringExtra(Intent.ACTION_APPLICATION_PREFERENCES)
                .toString()
        this.name = nameLocal
